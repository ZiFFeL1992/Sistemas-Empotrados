...
public:
	...
	/**
	 * \enum EDROOMCCServerSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum EDROOMCCServerSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SResAck, 
							SResNack, 
							SResReq, 
	...
	//! Constructor
	CCServer(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, TEDROOMStackSizeType roomStack, CEDROOMMemory * pActorMemory );
...
public:
	...
	enum EDROOMCCServerSignal { EDROOMSignalTimeout, EDROOMSignalDestroy, SResAck, SResNack, SResReq, SFreeRes };
		...
		CEDROOMInterface & pService1;
			...
			enum IdTrans{Init, FreeResource, ResRequest, ResRequest_Ack, ResRequest_Nack,  EDROOMMEMORIA };
		...
		EDROOMTopContext (CCServer &act, TEDROOMBool * EDROOMpVarVresFree, TEDROOMUInt8 & EDROOMpVarVresFreeNumber, CEDROOMPOOLTEDROOMUInt8 & EDROOMpPoolTEDROOMUInt8 );
	...
	public:
		...
		EDROOMTopState (CCServer &act, CEDROOMMemory *pEDROOMMemory  );
