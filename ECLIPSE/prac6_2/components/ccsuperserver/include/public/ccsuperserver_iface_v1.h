#ifndef CCSUPERSERVER_H_
#define CCSUPERSERVER_H_
 ...
 *
 */
class CCSuperServer: public CEDROOMComponent {

public:

	/**
	 * \enum EDROOMCCSuperServerSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum EDROOMCCSuperServerSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SResAck, 
							SResNack, 
							SResReq, 
	...
	/**
	 * \class CCSuperServer::CEDROOMMemory
	...
	//! Service1 Component Port
	CEDROOMInterface	Service1;
	...
	//! Constructor
	CCSuperServer(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, TEDROOMStackSizeType roomStack, CEDROOMMemory * pActorMemory );
...
public:
	...
	enum EDROOMCCSuperServerSignal { EDROOMSignalTimeout, EDROOMSignalDestroy, SResAck, SResNack, SResReq, SFreeRes };


		friend class CCSuperServer;

		CCSuperServer &EDROOMcomponent;
		...
		EDROOMTopContext (CCSuperServer &act );
	...
	public:
		...
		EDROOMTopState (CCSuperServer &act );
