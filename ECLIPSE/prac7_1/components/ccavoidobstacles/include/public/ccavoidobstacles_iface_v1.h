...
public:
	...
	/**
	 * \enum EDROOMCCAvoidObstaclesSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum EDROOMCCAvoidObstaclesSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SConfigAO, 
							SStart, 
							SObstacleDetected, 
	...
	//! Constructor
	CCAvoidObstacles(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, TEDROOMStackSizeType roomStack, CEDROOMMemory * pActorMemory );
...
public:
	...
	enum EDROOMCCAvoidObstaclesSignal { EDROOMSignalTimeout, EDROOMSignalDestroy, SConfigAO, SStart, SObstacleDetected, SConfigError, SConfigOK };
		...
		CEDROOMTimingInterface & Timer;
			...
			enum IdTrans{Init, Config, Start, CheckObstacles, CheckObstacles_ObstDetected, CheckObstacles_NoObstacle,  EDROOMMEMORIA };
		...
		EDROOMTopContext (CCAvoidObstacles &act, TEDROOMBool & EDROOMpVarVObsDetected );
	...
	public:
		...
		EDROOMTopState (CCAvoidObstacles &act );
