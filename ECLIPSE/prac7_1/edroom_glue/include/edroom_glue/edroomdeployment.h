...
class CEDROOMSystemMemory{
	...
	TEDROOMBool	comp1MessagesMarks[10];
	CEDROOMQueue::CQueueNode	comp1QueueNodes[16];
	TEDROOMBool	comp1QueueNodesMarks[16];
	...
	CCAvoidObstacles::CEDROOMMemory comp4Memory;
...
//Signal Conversion
	...
	static TEDROOMSignal C4AvoidObstacles_PAvoidObstaclesSysCtrl__C1MainActor_PAvoidObstaclesSysCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C1MainActor_PAvoidObstaclesSysCtrl__C4AvoidObstacles_PAvoidObstaclesSysCtrl(TEDROOMSignal signal);
...
//!Config Components
	...
	CCAvoidObstacles::CEDROOMMemory 		* GetComp4Memory(){return &systemMemory.comp4Memory;}
